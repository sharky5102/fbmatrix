...
class ledbuffer(geometry.base):
    ...
    fragment_code = """
        ...
        highp vec3 fetch_led_color(int pixel) {
            ...
            highp vec2 lamppos = lamp.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
            return textureLod(tex, lamppos, supersample).rgb;
        }
        ...
        void main()
        {
            ...
            highp vec3 color = pow(fetch_led_color(pixel), vec3(2.2));
